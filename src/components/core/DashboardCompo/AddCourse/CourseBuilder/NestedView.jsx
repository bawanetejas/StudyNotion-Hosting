...
import { deleteSection, deleteSubSection } from '../../../../../servicess/operations/CourseDetailApi'
import {AiFillCaretDown} from 'react-icons/ai'
import {FaPlus} from 'react-icons/fa'
import ConfirmationModal from '../../../../commen/LogoutModal'
...
function NestedView({handleChangeEditSectionName}) {
  ...
  return (
    <>
        <div className='rounded-lg bg-richblack-700 p-6 px-8 border-richblack-600'>
        {
            course?.courseContent?.map((section)=>{
               return  <details key={section._id}>
                       <summary className='flex cursor-pointer items-center justify-between border-b-2 border-b-richblack-600 py-2'>
                        <div className='flex items-center gap-x-3'>
                            <RxDropdownMenu className='font-semibold text-richblack-50'/>
               ...
               {/* render all the subsection within subsection */}
